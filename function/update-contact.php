...
// die(printf(isset($_FILES["photo"]["size"])));
$size = $_FILES["photo"]["size"];
// die(var_dump($_FILES["photo"]["size"]));
if($size > 0){
    // FPhoto 
...
$query = "UPDATE contacts SET `contact_name` = '$name', `contact_address` = '$address', `contact_phone` = '$phone', `contact_mail` = '$mail', `contact_photo` = '$photo_final' WHERE `contact_id` = '$uid'";
